...
<head>
    ...
    * {
    ...
    body {
        ...
        /* background: linear-gradient(to right, #e2e2e2, #4CAF50); */
        background: #fff;
        display: flex;
        align-items: center;
    ...
    <div class="container" id="container">
        ...
        <form action="{{ route('postRegister') }}" method="POST">
                ...
                <!-- <div class="form-group">
                    <label class="text-secondary">Pilih Jenis Kelamin</label>
                    <select class="form-control border border-secondary form-control-lg" name="jenisKelamin" required>
