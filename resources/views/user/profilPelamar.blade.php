                ...
                <div class="row">
                        ...
                        <div class="card text-center p-5">
                            <div class="card-body">
                                <div class="profile-picture-container">
                                    <img src="{{ asset('pelamar_images/' . $data->gambar) }}" alt="gambar"
                                ...
                                <div class="header_btn_1">
                                <a href="{{ route('user.editProfilPelamar', ['id' => $data->id]) }}"
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="shadow border rounded p-5 mb-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p class="card-text">
                                        <span class="text-muted mb-1 d-block"> <i
                                                class="fa-solid fa-person-half-dress me-2 text-success"></i>Jenis
                                            Kelamin
                                            :</span>
                                        {{ $data->jk }}
                                    </p> <!-- alamat end -->
                                    ...
                                    <p class="card-text">
                                        <span class="text-muted mb-1 d-block"> <i
                                                class="fa-solid fa-map-location-dot me-2 text-success"></i>Alamat
                                            :</span>
                                        {{ $data->alamat }}
                                    </p> <!-- alamat end -->

                                    <p class="card-text">
                                        <span class="text-muted mb-1 d-block"> <i class="fa-solid fa-calendar-days me-2 text-success"></i>Tanggal Lahir
                                            :</span>
                                        {{ $data->ttl }}
                                    </p> <!-- alamat end -->
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p class="card-text">
                                        <span class="text-muted mb-1 d-block"><i
                                                class="fa-solid fa-arrow-trend-up me-2 text-success"></i></i>Status
                                            :</span>
                                        {{ $data->status }}
                                    </p> <!-- alamat end -->
                                    ...
                                    <p class="card-text">
                                        <span class="text-muted mb-1 d-block"><i
                                                class="fa-solid fa-school me-2 text-success"></i>Institusi Pendidikan
                                            :</span>
                                    ...
                                    <p class="card-text">
                                        <span class="text-muted mb-1 d-block"><i
                                                class="fa-solid fa-book me-2 text-success"></i>Bidang Studi :</span>
                        ...
                        <div class="shadow border rounded p-5 mb-5">
                            ...
                            <span><i class="fa-solid fa-briefcase me-2 text-success"></i>Keahlian Saya</span>
                            <p>{{ $data->keahlian }}</p>
