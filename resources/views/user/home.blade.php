                                ...
                                <div class="main-nav__left main-nav__left_one float-left">
                                    ...
                                    <div class="main-nav__main-navigation two clearfix">
                                        <ul class=" main-nav__navigation-box float-left">
                                            ...
                                            <li class="dropdown">
                                                <a href="{{ route('user.Postingan') }}">Cari Loker</a>

                                            </li>
                                            <li class="dropdown">
                                                <a href="{{ route('user.Riwayat') }}">Riwayat Lamaran</a>

                                            </li>
                                            <li class="dropdown">
                                                <a href="{{ route('user.profilPelamar') }}">Profile</a>
                                            </li>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="image-layer"
                                style="background-image: url('{{ asset('assets/images/main-slider/3.jpg') }}');"></div>

                            <!-- /.image-layer -->
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <div class="image-layer"
                                style="background-image: url('{{ asset('assets/images/main-slider/2.jpg') }}');"></div>
                            <!-- /.image-layer -->
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <div class="image-layer"
                                style="background-image: url('{{ asset('assets/images/main-slider/z4.jpg') }}');"></div>
                            <!-- /.image-layer -->
                        </div><!-- /.swiper-slide -->
                    </div><!-- /.swiper-wrapper -->
