                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <div class="contact-panel">
                            <form action="/postPembayaran/{{ $lamarr->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <h3 class="contact-panel__title mb-20">Selamat Lamaran Anda Diterima </h3>
                                        <p class="contact-panel__desc mb-30">lakukan biaya administrasi sebesar Rp.50.000 di <b>No.Rek 0189-01-034439-50-0</b> untuk mendapatkan surat rekomendasi</p>
                                    </div> <!-- /.col-12 -->
                                   
                                    <!-- gambar -->
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="ijazahInput">Upload bukti pembayaran</label>
                                            <input type="file" id="ijazahInput" name="pembayaran" class="form-control-file">
                                             @if ($lamarr->pembayaran)
                                            <div class="file-name">File terpilih: {{ $lamarr->pembayaran }}</div>
                                            @endif
