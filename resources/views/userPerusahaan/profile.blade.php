            ...
            <div class="row">
                ...
                <div class="col-lg-4 ml-4">
                    ...
                    <div class="card text-center p-5">
                        ...
                        <div class="card-body">
                            <!-- <img src="{{ asset('usaha_images/' . $data->gambar) }}" alt="gambar"
                                class="img img-thumbnail rounded-circle w-50"
                                style="width: 60px; height: auto; border-radius: 50%;"> -->

                                <div class="profile-picture-container">
                                    <img src="{{ asset('usaha_images/' . $data->gambar) }}" alt="gambar"
                                        class="img img-thumbnail profile-picture" style="object-fit: cover;">
                                </div>


                            <h2>{{ Auth::user()->name }}</h2>

                            <p class="text-muted mb-1 d-block">
                                <!-- <span class="text-muted mb-1 d-block">Alamat Email</span> -->
                                <i class="fa-solid fa-envelope me-2 text-success"></i>{{ Auth::user()->email }}
                            </p>



                            <div class="header_btn_1">
                                <a href="{{ route('userPerusahaan.editProfilPerusahaan', ['id' => $data->id]) }}"
                ...
                <div class="col-lg-7">
                    ...
                    <div class="shadow border rounded p-5 mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block"> <i
                                            class="fa-solid fa-city me-2 text-success"></i>Bidang Industri:</span>
                                    {{ $data->jenis_bidang_perusahaan }}
                                </p> <!-- alamat end -->

                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block"> <i
                                            class="fa-solid fa-phone me-2 text-success"></i>Kontak:</span>
                                    {{ $data->kontak }}
                                </p> <!-- alamat end -->
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block"> <i
                                            class="fa-solid fa-map-location-dot me-2 text-success"></i>Alamat :</span>
                                    {{ $data->alamat }}
                                </p> <!-- alamat end -->
                    ...
                    <div class="shadow border rounded p-5 mb-5">
                        ...
                        <span><i class="fa-solid fa-building me-2 text-success"></i>Deskripsi Perusahaan</span>
                        <p>{{ $data->deskripsi_perusahaan }}</p>

                        <br> <br>

                        <span><i class="fa-solid fa-gear me-2 text-success"></i>Visi Perusahaan</span>
                        <p>{{ $data->visi }}</p>

                        <span><i class="fa-solid fa-flag me-2 text-success"></i>Misi Perusahaan</span>
                        <p>{{ $data->misi }}</p>
