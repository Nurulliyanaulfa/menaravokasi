                        ...
                        <div class="main-nav__left main-nav__left_one float-left">
                            ...
                            <div class="main-nav__main-navigation two clearfix">
                                <ul class=" main-nav__navigation-box float-left">
                                    <li class="dropdown">
                                        <a href="{{ route('userPerusahaan.home') }}">Beranda</a>
                                        
                                    </li>
                                    <li class="dropdown">
                                        <a href="{{ route('userPerusahaan.tambahPostingan') }}">Upload Loker</a>
                                    <li class="dropdown">
                                        <a href="{{ route('userPerusahaan.postingan') }}">Postingan saya</a>
                                       
                                    </li>
                                    <li class="dropdown">
                                        <a href="{{ route('userPerusahaan.profile') }}">Profile</a>
...
<section class="banner-one two">
    <div class="banner-two__bg-slide">
        <div class="thm-swiper__slider swiper-container" data-swiper-options='{"spaceBetween": 0, "loop": true, "effect": "fade", "slidesPerView": 1, "autoplay": { "delay": 5000 }, "pagination": { "el": "#banner-two__bg-slide-pagination", "type": "bullets", "clickable": true }}'>
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="image-layer" style="background-image: url('{{ asset('assets/images/main-slider/z1.jpg') }}');"></div>
                    <!-- /.image-layer -->
                </div><!-- /.swiper-slide -->
                <div class="swiper-slide">
                    <div class="image-layer" style="background-image: url('{{ asset('assets/images/main-slider/h8.jpg') }}');"></div>
                    <!-- /.image-layer -->
                </div><!-- /.swiper-slide -->
                <div class="swiper-slide">
    ...
    <div class="container">
        <div class="content-box">
            <div class="top-title">
                ...
                <h2>Selamat Bergabung di <br> Menara Vokasi </h2>
            </div>
        ...
        <section class="blog_one two">
            <div class="container">
                <form action="{{ route('userPerusahaan.home') }}" method="GET" class="d-flex">
                    @csrf
                    <div class="block-title text-center">
                        ...
                        <ul class="list-unstyled post-pagination d-flex justify-content-center align-items-center">
                            ...
                            <li><a href="{{ $data->nextPageUrl() }}">01</a></li>
                            <li><a href="{{ $data->nextPageUrl() }}">02</a></li>
                        ...
                        <div class="col-xl-5 col-lg-8 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="footer-widget__content">
                                ...
                                <div class="footer_widget__newsletter_bottom">
                                    ...
                                    <a href="mailto:needhelp@tolins.com">MenaraVokasi@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
